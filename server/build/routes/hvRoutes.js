...
class hvRoute {
    ...
    config() {
        ...
        this.router.post('/profileid', verifyTokenController_1.TokenValidation, hvController_1.default.profileid);
        this.router.put('/profileupd', verifyTokenController_1.TokenValidation, hvController_1.default.profileUpd);
